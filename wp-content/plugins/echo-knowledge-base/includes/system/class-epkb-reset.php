...
class EPKB_Reset {
	...
	public static function reset_articles_and_categories_sequence() {
		...
		EPKB_Utilities::ajax_show_info_die( __( 'The sequence for Articles and Categories was successfully reset.', 'echo-knowledge-base' ) );
	}
	...
	public static function show_articles_and_categories_sequence() {
		...
		if ( EPKB_Utilities::is_wpml_enabled( $kb_config ) ) {
			$article_sequence = EPKB_WPML::apply_article_language_filter( $article_sequence );
		}
