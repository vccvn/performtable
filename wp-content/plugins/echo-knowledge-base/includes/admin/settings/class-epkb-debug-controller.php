...
class EPKB_Debug_Controller {
	...
	public function toggle_debug() {
		...
		$text = empty( $is_debug_on ) ? __( 'Debug is now on', 'echo-knowledge-base' ) : __( 'Debug is now off', 'echo-knowledge-base' );

		// we are done here
		EPKB_Utilities::ajax_show_info_die( $text );
	}
	...
	public function show_logs() {
		...
		// we are done here
		EPKB_Utilities::ajax_show_info_die( __( 'Logs are now on', 'echo-knowledge-base' ) );
	}
	...
	public function enable_advanced_search_debug() {
		...
		// we are done here
		EPKB_Utilities::ajax_show_info_die( __( 'Debug for Advanced Search is now ' . ( empty( $is_debug_on ) ? 'on' : 'off' ), 'echo-knowledge-base' ) );
	}
