	...
	private static function get_features_config() {
		...
		return [
			[
				...
				'config'    => admin_url( '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $kb_id ) . '&page=epkb-kb-configuration#settings__order-articles' ),
			...
			[
				...
				'config'    => admin_url( '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $kb_id ) . '&page=epkb-kb-configuration#settings__various' ),
			...
			[
				...
				'custom'    => '<a class="epkb-kbnh__feature-link" href="' . esc_url( self::get_editor_zone_link( 'article_page', 'left_sidebar' ) ) . '" target="_blank"><span>' . esc_html__( 'Left Sidebar', 'echo-knowledge-base' ) . '</span></a>' .
				               '<a class="epkb-kbnh__feature-link" href="' . esc_url( self::get_editor_zone_link( 'article_page', 'right_sidebar' ) ) . '" target="_blank"><span>' . esc_html__( 'Right Sidebar', 'echo-knowledge-base' ) . '</span></a>',
			...
			[
				...
				'custom'    => '<a class="epkb-kbnh__feature-link" href="' . esc_url( self::get_editor_zone_link( 'article_page', 'created_date' ) ) . '" target="_blank"><span>' . esc_html__( 'Creation', 'echo-knowledge-base' ) . '</span></a>' .
				               '<a class="epkb-kbnh__feature-link" href="' . esc_url( self::get_editor_zone_link( 'article_page', 'last_updated_date' ) ) . '" target="_blank"><span>' . esc_html__( 'Last Update', 'echo-knowledge-base' ) . '</span></a>' .
								'<a class="epkb-kbnh__feature-link" href="' . esc_url( self::get_editor_zone_link( 'article_page', 'author' ) ) . '" target="_blank"><span>' . esc_html__( 'Author', 'echo-knowledge-base' ) . '</span></a>',
			...
			[
				...
				'config'    => admin_url( '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $kb_id ) . '&page=epkb-kb-configuration#tools__convert' ),
			...
			[
				...
				'config'    => admin_url( '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $kb_id ) . '&page=epkb-kb-configuration#settings__kb-urls' ),
			...
			[
				...
				'config'    => admin_url( '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $kb_id ) . '&page=epkb-kb-configuration#tools__export' ),
			...
			[
				...
				'config'    => admin_url( '/edit.php?post_type=' . EPKB_KB_Handler::get_post_type( $kb_id ) . '&page=epkb-kb-configuration#tools__import' ),
				'docs'      => 'https://www.echoknowledgebase.com/documentation/import-export-overview/',
				'video'     => '',
			],
		];
