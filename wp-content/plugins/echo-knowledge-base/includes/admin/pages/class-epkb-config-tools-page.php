...
class EPKB_Config_Tools_Page {
	...
	private static function get_other_boxes( $kb_config ) {
		...
		if ( ! EPKB_Utilities::is_amag_on() ) {
			...
			$boxes_config[] = array(
				...
				'html'  => EPKB_HTML_Elements::checkbox_toggle( [
					...
					'topDesc'       => '<a class="epkb-admin__input-field-desc" href="https://www.echoknowledgebase.com/documentation/translate-text/" target="_blank">' . esc_html__( 'Follow WPML setup instructions here.', 'echo-knowledge-base' ) . '</a>',
					'return_html'   => true,
				] ),
			);
		}
		...
		$boxes_config[] = array(
			...
			'title' => __( 'Archive or Delete KB', 'echo-knowledge-base' ),
