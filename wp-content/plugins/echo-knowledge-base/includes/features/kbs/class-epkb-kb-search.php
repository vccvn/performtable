		...
		<div class="epkb-doc-search-container <?php echo $main_page_indicator; ?>" <?php echo $style1; ?> >
			...
			<form id="epkb_search_form" <?php echo $form_style . ' ' . $class1; ?> method="get" action="/">
				...
				<div class="epkb-search-box">
					<input type="text" <?php echo $style4; ?> id="epkb_search_terms" aria-label="<?php echo esc_attr( $kb_config[$prefix . 'search_box_hint'] ); ?>" name="s" value="" placeholder="<?php echo esc_attr( $kb_config[$prefix . 'search_box_hint'] ); ?>" />
