...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'High-resolution/Retina Logo Support', 'pursuit' ),
    'description' => esc_html__( 'Automatically serve up your high-resolution logo to devices that support them.', 'pursuit' ),
    'section'     => 'logo',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'description' => esc_html__( 'Set height and then \'Publish\' BEFORE uploading your logo.', 'pursuit' ),
    'section'     => 'logo',
    'default'     => 100,
    'choices'     => array(
        'min'  => '10',
...
Pursuit_Kirki::add_field( 'theme_config_id', [
    'type'        => 'custom',
    'settings'    => 'themo_logo_resize_help',
    'label'       => esc_html__('Resizing', 'pursuit'),
    'section'     => 'logo',
    'default'     => '<div class="th-theme-support">' . __('To increase your logo size, set the new \'Logo Height\' above and \'Publish\' before you \'Remove\' and re-upload your logo. The theme resizes the logo during the upload process.', 'pursuit') . '</div>',
    'priority'    => 10,
] );
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'description' => esc_html__( 'For retina support, upload a logo that is twice the height set above.', 'pursuit' ) ,
    'section'     => 'logo',
    'default'     => '',
    'priority'    => 10,
) );
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'default'     => array(
        ...
        array(
            ...
            'themo_top_nav_icon'  => 'fa fa-comment-o',
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'High-resolution/Retina Image Support', 'pursuit' ),
    'description' => esc_html__( 'Automatically serve up high-resolution images to devices that support them.', 'pursuit' ),
    'section'     => 'misc',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'High-resolution/Retina Image Generator', 'pursuit' ),
    'description' => esc_html__( 'Automatically generate high-resolution/retina image sizes (@2x) when uploaded to your Media Library.', 'pursuit' ),
    'section'     => 'misc',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_section('plugins', array(
    'title' => esc_attr__('Plugins', 'pursuit'),
    'priority' => 2,
    'panel' => 'th_options',
    'capability' => 'edit_theme_options',
));
...
Pursuit_Kirki::add_field('pursuit_theme', array(
    ...
    'label' => esc_html__('Enabling bundled plugins', 'pursuit'),
    'section' => 'plugins',
    'priority' => 10,
    'default' => '<div class="th-theme-support">' . __('1 - Enable any of the listed bundled plugins.</p></p>2 - Publish your changes</p><p>3 - Follow the admin notice instructions on the WordPress dashboard to install.</p>', 'pursuit') . '</div>',
));
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'WooCommerce', 'pursuit' ),
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'Slider Revolution', 'pursuit' ),
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'Groovy Menu', 'pursuit' ),
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'Master Slider Pro', 'pursuit' ),
    'section'     => 'plugins',
    'default'     => 'off',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'Formidable Forms', 'pursuit' ),
    'section'     => 'plugins',
    'default'     => 'on',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'Simple Page Ordering', 'pursuit' ),
    'description' => esc_html__( 'Recommended for drag and drop sort ordering of custom post types.', 'pursuit' ),
    'section'     => 'plugins',
    'default'     => 'on',
    'priority'    => 10,
    'choices'     => array(
...
Pursuit_Kirki::add_field( 'pursuit_theme', array(
    ...
    'label'       => esc_html__( 'Widget Logic', 'pursuit' ),
    'description' => esc_html__( 'Recommended for displaying/hiding widgets on specific pages and areas.', 'pursuit' ),
    'section'     => 'plugins',
    'default'     => 'on',
    'priority'    => 10,
    'choices'     => array(
