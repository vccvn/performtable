...
<div class="inner-container<?php echo esc_attr($th_no_sidebar_class); ?>">
    ...
    <section id="<?php echo esc_attr( $key ).'_content'; ?>" class="<?php echo esc_attr( $masonry_section_class ); ?>">
        ...
        <div class="<?php echo esc_attr( $masonry_row_class ); ?> row">
            <?php if (!have_posts()) : ?>
                <div class="alert">
                    <?php _e('Sorry, no results were found.', 'pursuit'); ?>
                </div>
                <?php get_search_form(); ?>
            <?php endif; ?>
        ...
        <div class="row">
            <?php if ($wp_query->max_num_pages > 1) : ?>
                <nav class="post-nav">
                    <ul class="pager">
                            <li class="previous"><?php next_posts_link(__('&larr; Older posts', 'pursuit')); ?></li>
                            <li class="next"><?php previous_posts_link(__('Newer posts &rarr;', 'pursuit')); ?></li>
                    </ul>
                </nav>
            <?php endif; ?>
        </div>
