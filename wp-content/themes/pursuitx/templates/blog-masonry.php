...
<div class="inner-container">
    ...
    <div class="<?php echo sanitize_text_field($masonry_row_class); ?> row">
		<?php if (!have_posts()) : ?>
            <div class="alert">
            <?php esc_html_e('Sorry, no results were found.', 'pursuit'); ?>
            </div>
            <?php get_search_form(); ?>
        <?php endif; ?>
            ...
            <nav class="post-nav">
                <ul class="pager">
                    <?php if($use_th_bittersweet_pagination){
                        ...
                        <li class="previous"><?php next_posts_link(esc_html__('&larr; Older posts', 'pursuit')); ?></li>
                        <li class="next"><?php previous_posts_link(esc_html__('Newer posts &rarr;', 'pursuit')); ?></li>
                    <?php } ?>
                </ul>
            </nav>
        <?php endif; ?>
