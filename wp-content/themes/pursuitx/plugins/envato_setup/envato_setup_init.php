                ...
                public function theme_setup_wizard_content($content){
                    if($this->is_possible_upgrade()){
                        array_unshift_assoc($content,'upgrade',array(
                            'title' => __( 'Upgrade', 'pursuit' ),
                            'description' => __( 'Upgrade Content and Settings.', 'pursuit' ),
                            'pending' => __( 'Pending.', 'pursuit' ),
                            'installing' => __( 'Installing Updates.', 'pursuit' ),
                            'success' => __( 'Success.', 'pursuit' ),
                ...
                public function envato_setup_readyX() {
                    ...
                    <div class="envato-setup-next-steps">
                        ...
                        <div class="envato-setup-next-steps-last">
                            <h2><?php esc_html_e( 'More Resources', 'pursuit' ); ?></h2>
                            <ul>
                                ...
                                <li class="howto"><a href="https://wordpress.org/support/"
                                                     target="_blank"><?php esc_html_e( 'Learn how to use WordPress', 'pursuit' ); ?></a>
                                </li>
                                <li class="rating"><a href="http://themeforest.net/downloads"
                                                      target="_blank"><?php esc_html_e( 'Leave an Item Rating', 'pursuit' ); ?></a></li>
